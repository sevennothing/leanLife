...
import com.seven.leanLife.component.MenuItemBuilt;
...
public class EditorService {
    ...
    @Autowired
    public EditorService(final ApplicationController controller
                         ) {
    ...
    public FlowPane createEditorMenu(EditorPane editorPane){
        ...
        final Label saveLabel = LabelBuilt.icon(FontAwesome.SAVE, minSize)
                .clazz("top-label")
                .tip("Save").click(controller.editorController::saveDoc).build();
        final Label newLabel = LabelBuilt.icon(FontAwesome.FILE_TEXT_O, minSize)
                .clazz("top-label").tip("New File").click(controller.editorController::newDoc).build();
        final Label openLabel = LabelBuilt.icon(FontAwesome.FOLDER_OPEN_O, minSize)
                .clazz("top-label").tip("Open File").click(controller.editorController::openDoc).build();
        ...
        ObservableList<DocumentMode> modeList = controller.editorController.getModeList();
