package com.seven.leanLife.service;
...
public class DirectoryService {
    ...
    @Autowired
    public DirectoryService(final ApplicationController controller,
                            //final FileBrowseService fileBrowser,
                            final Current current,
                            //PathResolverService pathResolver,
                            //StoredConfigBean storedConfigBean,
    ...
    public Path findPathInCurrentOrWorkDir(String uri) {
        ...
        try {
            inCurrentParent = Optional.ofNullable(current.currentEditor().getPath().getParent());
        } catch (Exception e) {
            //no-op
        }
        try {
